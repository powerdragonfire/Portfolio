...
export type ProjectItemType = {
  ...
  gitStars?: number
  gitForks?: number
  /** Compact Problem / Role / Outcome breakdown shown on the flagship home tile instead of a plain paragraph. */
  caseStudy?: {
    problem: string
    role: string
    outcome: string
  }
  /** Suppresses the description on the home bento tile (still shown on /projects). */
...
export const projects: Array<ProjectItemType> = [
  {
    ...
    link: { href: '/projects/spontai', label: 'Spontai' },
    ...
    caseStudy: {
      problem:
        'Planning a trip means a dozen tabs, a group chat, and a spreadsheet nobody opens twice.',
      role:
        'Co-founder & CTO — built the product, the RAG pipeline, and the infrastructure.',
      outcome:
        'Live on the App Store in the UK and US, shipping fortnightly against 50+ TestFlight signals.',
    },
  },
  {
    name: 'SmartKnob',
  ...
  },
  {
    ...
    description:
      'Mobile engineer on a neobank fintech app for the Kenyan market — built account and payments flows in React Native/Expo against a Node/Express backend.',
    link: {
